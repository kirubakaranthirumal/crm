...
class PrivilegeTicketDetailsController extends Controller
{
	...
	public function show($id,Request $request){
	   ...
	   // print_r($responseArray);
		...
		if(!empty($userId)){
			...
			//return view('admin.ticket_form.ticket_details')->with('ticketdata', $ticketDetailArray,'historydata', $historyDetailArray,'tab_id'=>$tabId);

			return view('admin.ticket_form.privilege_ticket_details',['ticketdata'=>$ticketDetailArray,'historydata'=>$responseArray1,'tab_id'=>$tabId]);
		}
		else{
