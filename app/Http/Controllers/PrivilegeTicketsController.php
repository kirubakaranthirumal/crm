...
class PrivilegeTicketsController extends Controller{
	...
	public function index(){
		...
		*/
		return view('admin.ticket_form.privilege_add_tickets');
	}
	...
	public function load_group_user(Request $request){
		...
		if(!empty($responseArray->groupUserList)){
			foreach($responseArray->groupUserList as $responseVal){
