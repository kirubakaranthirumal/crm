...
class DeleteSocialMediaController extends Controller{
	...
	*/
	public function show($id, Request $request){
		...
		$menuValArray = $socialObj->deleteById($id);

		//print_r($menuValArray);
		//exit;

		//list data code starts here
		$successArray = $errorArray = $socialMediaArray = array();
		...
		try{
			$socialMediaArray = $this->retrieveAllContentManageInfo($params);
		...
		if(!empty($menuValArray)){
			session()->put('socialDelSuc','Menu has been Deleted successfully');
		}

		return view('admin.users.smsettings',['social'=>$socialMediaArray]);
	}
...
/* 	//create new department
	...
	public function retrieveAllContentManageInfo($params){
		$contentmanageObj = new SocialMedia();
