...
class PrivilegeAddTicketsController extends Controller{
	 ...
	 /**
	 	...
	 	public function index(Request $request){
	 		...
	 		if(!empty($userId)){
	 			return view('admin.ticket_form.padd_tickets',['app_data'=>$appListArray,'department'=>$department,'category'=>$category,'type'=>$type,'priority'=>$priority,'source'=>$source]);
	 		}
	 		else{
	 ...
	 <?php
	 		...
	 		*/
	 		...
	 		if((!empty($responseArray->status)) && ($responseArray->status == "200")){
	 			if(!empty($responseArray->msg)){
	 				...
	 				//return view('admin.ticket_form.padd_tickets',['app_data'=>$appListArray]);
	 				return view('admin.ticket_form.padd_tickets',['upload_error'=>$uploadError,'app_data'=>$appListArray]);
	 			}
	 		}
	     ...
	     public function addticket(){
	     	...
	     	if(!empty(session()->get('userId'))){
	 			return view('admin.ticket_form.padd_tickets');
	 		}
	 		else{
	 			return redirect('admin/login_user');
	 		}
	     ...
	     public function viewtickets(){
	     	...
	     	if(!empty(session()->get('userId'))){
	 			return view('admin.ticket_form.ptickets_list');
	 		}
	 		else{
	 			return redirect('admin/login_user');
	     ...
	     {
	     	if(!empty(session()->get('userId'))){
	 			return view('admin.ticket_form.pticket_details');
	 		}
	 		else{
	 			return redirect('admin/login_user');
	 			//header('Location:login_user');
