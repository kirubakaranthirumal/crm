...
class ReplyMailController extends Controller
{
    ...
    public function index(Request $request){
		...
		$head_val = imap_header($openmaildetail,168);
		...
		if(!empty($userId)){
			return view('admin.mailbox.reply',['mfolder' => $mfolder,'folderid' => $folderid,'fid' => $fid,'sidebarmail' => $sideBarData,'header_array' => $headerArray]);
		}
		else{
