...
class UsersController extends Controller
{
    ...
    public function store(Request $request){
		...
		if(
			...
			$results = SELF::AddUserPost("http://192.168.1.15:8080/cgwfollowon/addcrmuser",$cinputArray);
		}
	...
	public function userdetails($id){
		...
		if(!empty($cinputArray)){
			$results = SELF::EditUserPost("http://192.168.1.15:8080/cgwfollowon/findcrmuser",$cinputArray);
		}
