...
class TicketReportGenController extends Controller{
	...
	*/
	...
	public function store(Request $request){
		...
		if(!empty($userId)){
			return view('admin.ticket_form.tickets_report',['app_data'=>$appListArray,'ticketReportArray'=>$ticketReportArray ,'department'=>$department,'category'=>$category,'type'=>$type,'priority'=>$priority,'source'=>$source,'post'=>$inputArray,'status'=>$status]);
		}
		else{
			return redirect('admin/login_user');
		}
