...
class ReadMailController extends Controller
{
    ...
    public function show($id,Request $request){
		...
		return view('admin.mailbox.readmail', ['fid' => $fid,'sidebarmail' => $sidebarMailArray,'header_data' => $header_data,'msg_detail'=>$msgDetail]);

		/*
		if(!empty($userId)){
			return view('admin.mailbox.readmail', ['fid' => $fid,'sidebarmail' => $sidebarMailArray,'header_array' => $headerArray,'msg_detail'=>$msgDetail]);
		}
		else{
