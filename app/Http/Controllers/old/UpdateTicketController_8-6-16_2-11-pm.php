		...
		if(
			...
			if(!empty($userId)){
				...
				if(!empty($ticketArray->ticketGroupId)){
					return view('admin.ticket_form.edit_tickets',['req_groupid'=>$ticketArray->ticketGroupId,'ticketdata'=>$ticketArray]);
				}
				else{
					return view('admin.ticket_form.edit_tickets',['ticketdata'=>$ticketArray]);
				}
			}
			else{
				return redirect('admin/login_user');
