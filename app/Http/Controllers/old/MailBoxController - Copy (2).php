...
class MailBoxController extends Controller
{
	...
	public function email_folder_count($folder){

		$mbox = imap_open("{imap.gmail.com:993/ssl/novalidate-cert}", "kirubakaran.thirumal@gmail.com", "kiruba*1984", OP_HALFOPEN);

		$status = imap_status($mbox,'{imap.gmail.com:993/ssl}[Gmail]/$folder', SA_MESSAGES);
