...
<?php
		...
		*/
		...
		$departmentArray = $this->retrieveAllDepartmentInfo($input);
		$categoryArray = $this->retrieveAllCategoryInfo($input);
		$priorityArray = $this->retrieveAllPriorityInfo($input);
		$sourceArray = $this->retrieveAllSourceInfo($input);
		$typeArray = $this->retrieveAllTypeInfo($input);
		$statusArray = $this->retrieveAllStatusInfo($input);
