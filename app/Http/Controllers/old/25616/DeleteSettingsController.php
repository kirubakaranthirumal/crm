...
class DeleteSettingsController extends Controller{
	...
	*/
	public function show($id, Request $request){
		...
		return view('admin.users.settings',['department'=>$departmentArray,'category'=>$categoryArray,'priority'=>$priorityArray,'source'=>$sourceArray,'type'=>$typeArray,'set_id'=>$setId,'deptval'=>$depValArray,'catval'=>$catValArray,'priorityval'=>$priorValArray,'sourceval'=>$sourceValArray,'typeval'=>$typeValArray]);
	}
