...
class UpdateTicketController extends Controller
{
	 ...
	 public function show($id,Request $request){
		...
		if(
			...
			if(!empty($responseArray->ticketGroupId)){
				return view('admin.ticket_form.edit_tickets',['req_groupid'=>$responseArray->ticketGroupId,'ticketdata'=>$responseArray]);
			}
			else{
				return view('admin.ticket_form.edit_tickets',['ticketdata'=>$responseArray]);
			}
    ...
    public function UpdateTicketPost($url,$params){
		...
		if(!empty($params['ticketStatus'])){
			$fields['ticketStatus'] = $params['ticketStatus'];
		}
