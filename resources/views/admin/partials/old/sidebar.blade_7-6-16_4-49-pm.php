		...
		@if(isset($usertype))
			@if($usertype == 1)
				<ul class="sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
					...
					<li class="treeview">
						<a href="#"><i class="fa fa-ticket" aria-hidden="true"></i><span>User Privilege</span> <i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
							<li><a href="{{ url(config('quickadmin.route').'/user_privileges') }}"><i class="fa fa-ticket" aria-hidden="true"></i> <span>Assign Privilege</span></a></li>
							<!--<li><a href="#">Link in level 2</a></li>-->
						</ul>
					</li>
					<li class="treeview">
					...
					<li class="treeview">
						<a href="#"><i class="fa fa-ticket" aria-hidden="true"></i><span>Settings</span> <i class="fa fa-angle-left pull-right"></i></a>
						<ul class="treeview-menu">
