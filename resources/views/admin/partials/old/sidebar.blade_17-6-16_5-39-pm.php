		...
		@if(isset($usertype))
			@if($usertype == 1)
				<ul class="sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
					...
					<li>
						<a href="{{ url(config('quickadmin.route').'/user_log_status') }}">
							<i class="fa fa-genderless"></i> <span>Employee Status</span>
						</a>
					</li>
					<li class="treeview">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<li><a href="{{ url(config('quickadmin.route').'/emailnotification') }}"><i class="fa fa-envelope" aria-hidden="true"></i> <span>E-Mail Notification</span></a></li>
						</ul>
					</li>
					<li class="treeview">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
						    ...
						    <li><a href="{{ url(config('quickadmin.route').'/create_service') }}"><i class="fa fa-ticket" aria-hidden="true"></i> <span>Create Service</span></a></li>
					...
					<li>
						<a href="{{ url(config('quickadmin.route').'/customer_info') }}">
							<i class="fa fa-user-secret"></i> <span>Access To Customer Info</span>
						</a>
					</li>
					<!--<li class="treeview">
