		...
		@if(isset($usertype))
			@if($usertype == 1)
				<ul class="sidebar-menu" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
					...
					<li><a href="{{ url('/empsendmail') }}"><i class="fa fa-envelope" aria-hidden="true"></i> <span>Mail To Internal Users</span></a></li>
					<li class="treeview">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<li><a href="{{ url(config('quickadmin.route').'/mailaccsettings') }}"><i class="fa fa-envelope" aria-hidden="true"></i><span>Mail Account Settings</span></a></li>
							<li><a href="{{ url(config('quickadmin.route').'/smsettings') }}"><i class="fa fa-wifi" aria-hidden="true"></i><span>Social Media Settings</span></a></li>
							<li class="treeview">
