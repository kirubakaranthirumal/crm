			...
			<div class="box-body">
              <div class="nav-tabs-custom">
                <ul class="nav nav-tabs tabs-dark">
                  ...
                  <li><a href="#inactive" data-toggle="tab">Offline User</a></li>
               ...
               <!--   <th>Action</th>-->
                ...
                <!--<tfoot>
                  ...
                  <div class="tab-pane" id="inactive">
                    <!-- The timeline -->
				<table id="example2" class="table table-custom table-striped">
                <thead>
                <tr>
                  <th>Name</th>
                  <th>E-mail</th>
