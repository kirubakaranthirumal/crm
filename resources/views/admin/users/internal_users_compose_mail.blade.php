					...
					@if(session('mailSendSuccess'))
						<div class="flash-message">
							<div class="alert alert-success">
								{{session('mailSendSuccess')}}
								<script language="javascript">
									window.setTimeout(function(){window.location.href = "{{asset('/admin/empsendmail/')}}";}, 1000);
								</script>
							</div>
						</div>
					@endif
					...
					<!-- tile -->
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Compose New  </strong>Message</h1>
                                    <ul class="controls">
                                        <li class="dropdown">
								...
								<!--<div style="border:0px solid red;clear:both;">&nbsp;</div>-->
								<div style="border:0px solid red;margin-left:2%;">
									<h5>Mail can be sent to a particular group or an employee in a particular group</h5>
								</div>
								...
								<div class="box-footer">
									...
									<button type="submit" name="submit" value="Submit" class="btn btn-cyan btn-ef btn-ef-3 btn-ef-3c mb-10">Send <i class="fa fa-paper-plane" aria-hidden="true"></i></button>
