						...
						<div class="tab-content">
							<div class="tab-pane" id="active">
								...
								<ul style="list-style: none;">
									...
									<a id="modal-department" href="#modal-container-department{{$key}}" role="button" class="modalButton" data-toggle="modal" data-message="" ><img height="42" width="42" title="reply" src="{{asset("images/reply-action.png")}}" class="img-circle" alt="Reply"></a>
									</div>
									<div style="float:left;width:50%;padding:15px 0px 0px 5px">
