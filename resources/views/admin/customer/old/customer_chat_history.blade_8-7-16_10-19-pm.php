		...
		<div class="col-md-12">
			...
			<div class="box box-primary">
				<div class="box-header with-border">
					<h3 class="box-title">Customer Chat History</h3>
				</div><!-- /.box-header -->
					<div class="box-body">
						...
						<?php $i=0;?>
							...
							<script language="javascript">
								...
								$http.get("http://192.168.1.205:93/cricketgateway/1.3/public/admin/fetchchats",{
									headers:{
							...
							$http.get("http://192.168.1.205:93/cricketgateway/1.3/public/admin/tick_cnt", {
							headers: {
							'Content-type': 'application/json'
							}
							}).then(function(response) {
						...
						<div id="loginform" style="background:transparent;">
						    ...
						    <div style="height:30px;float:right;clear:both;width:100%;text-align:right"><span  id="minchat" style="width:50px;background:#333;padding:5px 10px 5px 10px;margin-right:5px;cursor:pointer">-</span><span  id="closechat" style="width:50px;background:#333;padding:5px 10px 5px 10px;cursor:pointer">X</span></div>
								<div id="chatbox"></div>
								<div width="100%"><input type="hidden" name="chatfile" id="chatfile"  /><input type="text" id="msg1" style="color: #333;height: 50px;
    width: 84%;"><input type="button"  style="background: #333 none repeat scroll 0 0;border: medium none; color: white;height: 50px;margin-left: 5px;" id="submitmsg1" value="submit"><input type="hidden" name="name1" id="name1"></div>
						...
						$(document).ready(function() {
									...
									var str4 = "http://192.168.1.205:93/cricketgateway/1.3/public/chat/post.new.php";
								...
								$(document).keypress(function(e){
								   ...
								   loadLog($("#chatfile").val());
									...
									function loadLog(filename){
									                ...
									                var str1 = "http://192.168.1.205:93/cricketgateway/1.3/public/chat/loghtml/log.";
									                var str2 = "firstchat";
									//alert(str2);
									                var str3 = ".html";

									                        var filename =  "http://192.168.1.205:93/cricketgateway/1.3/public/chat/loghtml/log."+filename+".html";
