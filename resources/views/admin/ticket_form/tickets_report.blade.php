				...
				<!-- tile -->
                            <section class="tile">
                                ...
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Filter Ticket </strong></h1>
                                    <ul class="controls">
                                        <li class="dropdown">
						...
						<form action="" method="POST" id="ticket-form" novalidate="novalidate">
							...
							<button type="submit" name="searchsubmit" id="searchsubmit" value="Filter" class="btn btn-cyan btn-ef btn-ef-3 btn-ef-3c mb-10">Filter <i class="fa fa-filter" aria-hidden="true"></i></button>
					...
					?>
							<script language="javascript">
								load_event('<?=$inputArray['application']?>','<?=$inputArray['event']?>');
							</script>
					<?php
						}
					?>
					...
					<section class="tile">
                                ...
                                <!-- tile header -->
                                <div class="tile-header dvd dvd-btm">
                                    <h1 class="custom-font"><strong>Report Generate</strong> Table</h1>
                                    <ul class="controls">
                                        <li class="dropdown">
                                ...
                                <!-- tile body -->
					<div class="box box-primary tile-body"  id="report_data">
						<div class="box-header with-border">

							<div class="pull-right" style="padding-bottom:10px; border:0px solid red;">
								<div class="pull-left" style="margin-right:5px;border:0px solid red;">
									Download as
								</div>
								<script language="javascript">
									/*jQuery.noConflict();
								...
								<div class="pull-right" style="margin-right:0px;border:0px solid red;">
								...
								<table id="ticket_list" class="table table-custom table-striped dt-responsive">
									<thead>
										<tr>
											<th>ID</th>
											<th>Request From</th>
