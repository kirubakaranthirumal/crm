						...
						<form action="" method="POST" id="ticket-form" class="form-horizontal" novalidate="novalidate" enctype= multipart/form-data>
							<div class="col-md-6">
								...
								<div class="form-group">
									...
									<!--<input type="text" name="requester_name" id="requester_name" class="form-control" placeholder="Requester Name" tabindex="3">-->
									<input type="text" name="requester_email" id="requester_email" class="form-control" placeholder="Requester E-Mail" tabindex="5">
								</div>
								<div class="form-group">
									<label>Subject <span id="required">*</span></label>
									<input type="text" name="subject" id="subject" class="form-control" placeholder="Subject" tabindex="7">
								</div>
								<div class="form-group">
									<label>Type <span id="required">*</span></label>
									<select class="form-control" name="type" id="type" tabindex="9">
								...
								<div class="form-group">
									...
									<select class="form-control" name="source" id="source" tabindex="11">
								...
								<div class="form-group">
									...
									<select class="form-control" name="category" id="category" tabindex="13">
								...
								<div class="form-group">
									...
									<select class="form-control" name="status" id="status" tabindex="15">
