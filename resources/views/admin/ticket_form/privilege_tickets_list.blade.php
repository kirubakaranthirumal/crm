								...
								@if(isset($ticketcountdata))
									@foreach($ticketcountdata as $countData)
										...
										<li class="@if(isset($total_active_tab)){{$total_active_tab}}@endif">
											<a href="pticket?tab_id=0" aria-expanded="false">
										...
										@foreach($status as $stat)
											...
											<li class="@if($tab == $stat['statusId']) active @endif">
												<a href="pticket?tab_id={{$stat['statusId']}}" aria-expanded="false">
											...
											@foreach($ticketdata as $data)
												<tr>
													...
													<td>
														...
														?>
															<a class="btn btn-rounded-20 btn-default btn-sm mr-5 bg-danger" style="width:30px;" href="{{asset('/admin/ticket_details/')}}/@if(isset($data->ticketId)){{ $data->ticketId}}@endif" title="View Ticket">
