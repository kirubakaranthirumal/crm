          ...
          <div class="row">
            ...
            <div class="col-md-12">
				...
				<div class="col-md-12">
					...
					<a id="modal-status" href="#modal-container-status" role="button" class="btn btn-primary" data-toggle="modal">Add Status</a>
					...
					<!--Add/Edit Status code starts-->
						<div class="container-fluid">
							<div class="row">
								<div class="col-md-12">
									<div class="modal fade" id="modal-container-status" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
										<div class="modal-dialog">
											<div class="modal-content">
												<div class="modal-header">
													<button type="button" class="close" data-dismiss="modal" aria-hidden="true">x</button>
