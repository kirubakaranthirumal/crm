          ...
          <div class="row">
            ...
            <div class="col-md-12">
            	<?php
					...
					echo session()->get('departmentSuc');
					exit;
				...
				@if(session('departmentSuc'))
					<div class="flash-message">
						<div class="alert alert-success">
							...
							<script language="javascript">
								window.setTimeout(function(){window.location.href = "{{asset('/admin/settings/')}}";}, 500);
							</script>
						</div>
					</div>
				@elseif(session('categorySuc'))
					<div class="flash-message">
						<div class="alert alert-success">
							...
							<script language="javascript">
								window.setTimeout(function(){window.location.href = "{{asset('/admin/view_user/')}}";}, 500);
							</script>
						</div>
					</div>
											...
											<tr>
												...
												<td>
													@if(isset($department_data['deptId']))
														<a href="{{asset('/admin/del_dept/')}}/@if(isset($department_data['deptId'])){{ $department_data['deptId']}} @endif" title="delete">
															<i class="fa fa-remove"></i>
														</a> &nbsp;&nbsp;
														<a href="{{asset('/admin/edit_dept/')}}/@if(isset($department_data['deptId'])){{ $department_data['deptId']}} @endif" title="edit">
											...
											<tr>
												...
												<td>
													@if(isset($category_data['categoryId']))
														<a href="{{asset('/admin/del_cat/')}}/@if(isset($category_data['categoryId'])){{ $category_data['categoryId']}} @endif" title="delete">
															<i class="fa fa-remove"></i>
														</a> &nbsp;&nbsp;
														<a href="{{asset('/admin/edit_cat/')}}/@if(isset($category_data['categoryId'])){{ $category_data['categoryId']}} @endif" title="edit">
															<i class="fa fa-edit"></i>
														</a>
													@endif
												</td>
											...
											<tr>
												...
												<td>
													@if(isset($priority_data['priorityId']))
														<a href="{{asset('/admin/del_prior/')}}/@if(isset($priority_data['priorityId'])){{ $priority_data['priorityId']}} @endif" title="delete">
															<i class="fa fa-remove"></i>
														</a> &nbsp;&nbsp;
														<a href="{{asset('/admin/edit_prior/')}}/@if(isset($priority_data['priorityId'])){{ $priority_data['priorityId']}} @endif" title="edit">
															<i class="fa fa-edit"></i>
														</a>
													@endif
												</td>
											...
											<tr>
												...
												<td>
													@if(isset($source_data['sourceId']))
														<a href="{{asset('/admin/del_source/')}}/@if(isset($priority_data['sourceId'])){{ $priority_data['sourceId']}} @endif" title="delete">
															<i class="fa fa-remove"></i>
														</a> &nbsp;&nbsp;
														<a href="{{asset('/admin/edit_source/')}}/@if(isset($priority_data['sourceId'])){{ $priority_data['sourceId']}} @endif" title="edit">
															<i class="fa fa-edit"></i>
														</a>
													@endif
												</td>
											...
											<tr>
												...
												<td>
													@if(isset($type_data['typeId']))
														<a href="{{asset('/admin/del_type/')}}/@if(isset($priority_data['typeId'])){{ $priority_data['typeId']}} @endif" title="delete">
															<i class="fa fa-remove"></i>
														</a> &nbsp;&nbsp;
														<a href="{{asset('/admin/edit_type/')}}/@if(isset($priority_data['typeId'])){{ $priority_data['typeId']}} @endif" title="edit">
															<i class="fa fa-edit"></i>
														</a>
													@endif
												</td>
