...
<div class="page page-forms-common">
	...
	<!-- tile -->
	<section class="tile">
		@if(session('countrySuccess'))
			<div class="flash-message">
				<div class="alert alert-success">
					{{session('countrySuccess')}}
					<script language="javascript">
		...
		@endif
		@if(session('countryError'))
			<div class="flash-message">
				<div class="alert alert-danger">
					{{session('countryError')}}
				</div>
			</div>
		@endif		
		<div style="clear:both;"></div>		
			...
			<h1 class="custom-font"><strong>Create Country</strong></h1>
				<ul class="controls">
					<li class="dropdown">
			...
			<!-- tile body -->
			<div class="tile-body">
				<form action="#" method="POST" id="country-form" class="form-horizontal" novalidate="novalidate" enctype="multipart/form-data">
					<div class="col-md-6">
						<input type="hidden" name="_token" value="{{ csrf_token() }}">
						<div class="form-group">
							<label>Name <span id="required">*</span></label>
							<input type="text" name="country_name" id="country_name" class="form-control" placeholder="Name" tabindex="1">
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group" style="width: 96%;">
								...
								<input type="text" name="country_flag" id="country_flag" class="form-control" placeholder="Flag" tabindex="3">
								<!--<input type="text" name="ticket_attachment" id="ticket_attachment" tabindex="3" class="form-control" readonly>-->
							</div>
							
						</div>
						<!--<hr class="line-dashed line-full"/>
						<div class="form-group">
							<label>Mobile Number Digits<span id="required">*</span></label>
							<input type="text" name="country_mobile_digits" id="country_mobile_digits" class="form-control" placeholder="Mobile Digits" tabindex="5">
						</div>-->					
					</div>
					<div class="col-md-6">
						<div class="form-group">
							<label>Short Name</label> <span id="required">*</span></label>
							<input type="text" name="country_short_name" id="country_short_name" class="form-control" placeholder="Short Name" tabindex="2">
						</div>
						<hr class="line-dashed line-full"/>
						<div class="form-group">
							<label>Code</label> <span id="required">*</span></label>
							<input type="text" name="country_code" id="country_code" class="form-control" placeholder="Code" tabindex="4">
						</div>	
						<hr class="line-dashed line-full"/>
					</div>
